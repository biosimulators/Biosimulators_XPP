...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biosimulators_xpp')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulators/Biosimulators_XPP/blob/dev/'
project = 'BioSimulators-XPP'
...
html_theme_options = {
    ...
    'github_repo': 'Biosimulators_XPP',
    'github_banner': True,
    'github_button': True,
    'description': 'BioSimulators-compliant interface to XPP',
    'fixed_sidebar': True,
